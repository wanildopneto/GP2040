...
#define HTTPD_SERVER_AGENT \
  "lwIP/1.4.1 (http://savannah.nongnu.org/projects/lwip)"
#endif
...
static const char *const g_psHTTPHeaderStrings[] = {
    ...
    "Content-type: text/html\r\nExpires: Fri, 10 Apr 2008 14:00:00 "
    "GMT\r\nPragma: no-cache\r\n\r\n",
...
const static tHTTPHeader g_psHTTPHeaders[] = {
    {"html", HTTP_HDR_HTML}, {"htm", HTTP_HDR_HTML},  {"shtml", HTTP_HDR_SSI},
    {"shtm", HTTP_HDR_SSI},  {"ssi", HTTP_HDR_SSI},   {"gif", HTTP_HDR_GIF},
    {"png", HTTP_HDR_PNG},   {"jpg", HTTP_HDR_JPG},   {"bmp", HTTP_HDR_BMP},
    {"ico", HTTP_HDR_ICO},   {"class", HTTP_HDR_APP}, {"cls", HTTP_HDR_APP},
    {"js", HTTP_HDR_JS},     {"ram", HTTP_HDR_RA},    {"css", HTTP_HDR_CSS},
    {"swf", HTTP_HDR_SWF},   {"xml", HTTP_HDR_XML},   {"xsl", HTTP_HDR_XML},
};
...
#if LWIP_HTTPD_SSI
static const char *const g_pcSSIExtensions[] = {".shtml", ".shtm", ".ssi",
                                                ".xml"};
